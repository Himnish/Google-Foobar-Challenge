...
class Node:
    def __init__(self, x, y, bypasses, grid):
        """
        : x: The x coordinate of the node on our grid.
        : y: The y coordinate of the node on our grid.
        : bypasses: The number of walls we can skip.
        : grid: The grid itself. All nodes know of the original matrix.
        """
        self.x = x
        self.y = y
...
class PathFinder:
    def __init__(self, grid, bypasses):
        """
        : grid: The matrix resembling our maze.
        : bypasses: The number of walls that we can pass on this iteration of the algorithm.
        """
        self.grid = grid
